  ...
  <v-layout row>
    <v-flex md3>
      <v-app :style="{background: $vuetify.theme.themes.light.background}">
        <v-container>
          <v-flex>
            <v-card class="ma-5 text-center mt-8" shaped elevation="10">
              ...
              <v-card-title class="layout justify-center">使用者</v-card-title>
              <v-card-subtitle class="layout justify-center">24year</v-card-subtitle>
              <v-list class="mt-n5">
                <v-list-item>
        ...
        <v-flex>
         <v-card class="ma-5 text-center mt-11" shaped elevation="10">
          ...
          <v-flex>
            <v-list class="mt-5">
              <v-list-item>
                ...
                <v-list-item-action>
                  <v-btn class="ma-2" title outlined="" color="cyan darken-1">
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="10">
                    <v-list two-line="" subheader="" class="ml-n8">
                      <v-list-item>
                        <v-list-item-content>
                           <v-list-item-subtitle>26 Aug 2020</v-list-item-subtitle>
                           <v-list-item-title>Hyper crisis</v-list-item-title>
                           <v-list-item-subtitle>ongoing</v-list-item-subtitle>
                        </v-list-item-content>
                      </v-list-item>
                    </v-list>
                  </v-col>
